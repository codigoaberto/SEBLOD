			...
			(function ($){
				...
				$(document).ready(function(){
					...
					$(".fill").live("click", function() {
						...
						if (field) {
							var url = "index.php?option=com_cck&task=box.add&tmpl=component&file=components/com_cck/views/field/tmpl/selection.php&title=conditionnal&name="+field+"&type="+id+"_conditions"+idx+"_value";
